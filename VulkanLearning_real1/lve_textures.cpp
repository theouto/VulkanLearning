...
namespace lve
{
	void LveTextures::createTextureImage(LveDevice& device)
	{
		...
		LveBuffer buffer = LveBuffer(device, imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, 
