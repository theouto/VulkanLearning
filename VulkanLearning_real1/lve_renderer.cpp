...
namespace lve
{
	...
	void LveRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't call beginSwapChainRenderPass on commandBuffer from a different frame");
	...
	void LveRenderer::endSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't call endSwapChainRenderPass on commandBuffer from a different frame");
